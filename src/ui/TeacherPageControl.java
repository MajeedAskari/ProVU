...
public class TeacherPageControl {
	...
	public TeacherPageControl(Stage primaryStage, UiController uc) {
	...
	public void teacherPageControl(int userId) {
		...
		MenuItem newClass = mb.getMenus().get(0).getItems().get(0);
		MenuItem newPost = mb.getMenus().get(0).getItems().get(1);
		MenuItem addStu = mb.getMenus().get(0).getItems().get(2);
